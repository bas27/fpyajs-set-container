...
## `Set` (Домашнее задание к лекции «Контейнеры») [![Build status](https://ci.appveyor.com/api/projects/status/wh15j97hua2vrcti?svg=true)](https://ci.appveyor.com/project/bas27/fpyajs-set-container)
